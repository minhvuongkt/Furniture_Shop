                                                ...
                                                <div class="card-block">
                                                    <form class="form-material" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <div class="form-group form-info">
                                                            <input type="text" name="nameproduct" class="form-control fill" value="${productedit.name}" autofocus required>
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Tên Mặt Hàng</label>
                                                        </div>
                                                        <div class="form-group form-info">
                                                            <input type="text" name="detail" class="form-control fill" value="${productedit.detail}" required>
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Mô Tả Mặt Hàng</label>
                                                        </div>
                                                        <div class="form-group form-info">
                                                            <input type="int" name="price" class="form-control fill" value="${productedit.price}" required>
                                                            <span class="form-bar"></span>
                                                        ...
                                                        <div class="form-group form-info">
                                                            <select name="categoryid" class="form-control fill" required>
                                                                ...
                                                                <c:forEach items="${listCategories}" var="item">
                                                                    <c:if test="${productedit.categoryID == item.id}">
                                                        ...
                                                        <div class="form-group form-info">
                                                            <select name="status" class="form-control fill" required>
                                                                <c:if test="${productedit.isSelling}">
                                                                    <option value="true" selected>Mặt Hàng Đang Bán</option>
                                                                    <option value="false">Mặt Hàng Ngừng Bán</option>
                                                                </c:if>
                                                                <c:if test="${!productedit.isSelling}">
                                                                    <option value="true" >Mặt Hàng Đang Bán</option>
                                                                    <option value="false" selected>Mặt Hàng Ngừng Bán</option>
                                                                </c:if>
                                                            </select>
                                                            <span class="form-bar"></span>
                                                        </div>
                                                        ...
                                                        <div class="form-group form-info">
                                                            ...
                                                            <div class="col-sm">                
                                                                <input type="hidden" name="photo" value="${productedit.photo}"/>
                                                        ...
                                                        <div class="form-group form-info">
                                                            <div class="col-lg-offset-2 col-sm-10"> 
                                                                <img id="Photo" src="<c:url value='/assets/images/${productedit.photo}'/>" class="img img-bordered" style="width:200px" alt="NoPhoto" />
                                                            </div>
                                                        </div>
