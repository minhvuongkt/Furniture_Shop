                        ...
                        <form class="md-float-material form-material" method="post" >
                            <div class="auth-box card">
                                <div class="card-block">
                                        ...
                                        <div class="col-12">
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    ...
                                                    <!--<span class="text-inverse">Ghi Nhớ Lần Sau?</span>-->
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <p class="text-inverse text-left">Chưa tạo tài khoản? <a href="register" class="text-danger font-weight-bold" style="font-weight: 800;">TẠO NGAY CHO KAO</a></p>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
